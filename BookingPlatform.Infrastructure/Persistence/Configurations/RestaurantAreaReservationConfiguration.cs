...
public sealed class RestaurantAreaReservationConfiguration : IEntityTypeConfiguration<RestaurantAreaReservation>
{
    public void Configure(EntityTypeBuilder<RestaurantAreaReservation> builder)
    {
        builder.ToTable("restaurant_area_reservations");
