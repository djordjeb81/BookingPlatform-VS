...
namespace BookingPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260611182652_AddHasCustomerSeatingToBusinessFeatureSettings")]
    partial class AddHasCustomerSeatingToBusinessFeatureSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingPlatform.Domain.Restaurants.RestaurantDeliveryZone", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("restaurant_delivery_zones", (string)null);
                });
            ...
            modelBuilder.Entity("BookingPlatform.Domain.Restaurants.RestaurantOrder", b =>
                {
                    ...
                    b.Property<string>("DeliveryZoneNameSnapshot")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BookingPlatform.Domain.Restaurants.RestaurantSettings", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("IsDeliveryLocationRequired")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsScheduledOrderingEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<int>("PreparationReminderBufferMin")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(10);

                    b.Property<int>("ScheduledOrderMaxDaysAhead")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(7);

                    b.Property<int>("ScheduledOrderMinLeadTimeMin")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(30);
